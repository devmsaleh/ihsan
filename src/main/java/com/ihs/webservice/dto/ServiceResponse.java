...
public class ServiceResponse {
    ...
    public ServiceResponse(ErrorCodeEnum errorCode, Object responseData, ErrorCodeRepository errorCodeRepository, String lang) {
        super();
        this.errorCode = errorCode;
        response = new HashMap<String, Object>();
    ...
    public String getErrorCodeDesc() {
        if (errorCodeRepository != null) {
            com.ihs.entities.ErrorCode err = errorCodeRepository.findById(new Long(getErrorCodeValue()));
            if (err == null)
                return errorCode + "";

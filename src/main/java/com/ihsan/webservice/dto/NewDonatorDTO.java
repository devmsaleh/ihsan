...
public class NewDonatorDTO {

    private String donatorName;
    private String donatorCountryId;
    ...
    public String getDonatorCountryId() {
        return donatorCountryId;
    }

    public void setDonatorCountryId(String donatorCountryId) {
        this.donatorCountryId = donatorCountryId;
    }

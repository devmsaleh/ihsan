...
Insert into ERROR_CODE (ID,ACTIVE,ERROR_CODE,ERROR_NAME_ARABIC,ERROR_NAME_ENGLISH) values (51,1,'OLD_PASSWORD_WRONG','كلمة السر القديمة غير صحيحة','Old password is wrong');
Insert into ERROR_CODE (ID,ACTIVE,ERROR_CODE,ERROR_NAME_ARABIC,ERROR_NAME_ENGLISH) values (52,1,'CHARITYBOX_MUST_BE_ASSIGNED_TO_SUBLOCATION','يجب أن يتم تعيين الحصالة الى موقع','charitybox must be assigned to sublocation');